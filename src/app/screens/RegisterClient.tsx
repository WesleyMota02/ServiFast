...
export function RegisterClient() {
  ...
  if (step === 4) {
    return (
      <div className="min-h-screen bg-white flex flex-col items-center justify-center p-6 text-center">
        ...
        <h1 className="text-2xl font-bold text-[#1A1A1A] mb-2 font-[Poppins]">Conta criada com sucesso!</h1>
        <p className="text-[#1A1A1A] text-lg mb-4">Bem-vindo ao ServiFast, {formData.nome.split(" ")[0] || "Cliente"}!</p>
        ...
        <button 
          ...
          className="w-full max-w-sm bg-[#FF6B00] text-white font-bold py-4 rounded-xl shadow-[0_4px_12px_rgba(255,107,0,0.30)] transition-transform active:scale-95"
        >
          Ir para o início →
        </button>
      </div>
  ...
  return (
    <div className="min-h-screen bg-white pb-24 font-[Poppins]">
      ...
      {/* Stepper */}
      <div className="px-6 mb-8 max-w-[280px] mx-auto">
      ...
      <div className="px-6">
        {step === 1 && (
          <div className="animate-in fade-in slide-in-from-right-4 duration-300">
            <h1 className="text-[22px] font-bold text-[#1A1A1A] mb-1">Criar conta</h1>
            <p className="text-[14px] text-[#6B6B6B] mb-8">Etapa 1: Seus dados</p>
        ...
        {step === 2 && (
          <div className="animate-in fade-in slide-in-from-right-4 duration-300">
            <h1 className="text-[22px] font-bold text-[#1A1A1A] mb-1">Onde você mora?</h1>
            <p className="text-[14px] text-[#6B6B6B] mb-8">Etapa 2: Localização</p>
            ...
            <div className="space-y-6">
              ...
              <FloatingInput 
                icon={<MapPin size={20} />} label="Bairro" value={formData.bairro}
        ...
        {step === 3 && (
          <div className="animate-in fade-in slide-in-from-right-4 duration-300">
            ...
            <p className="text-[14px] text-[#6B6B6B] mb-8">Etapa 3: Sua foto</p>
            ...
            <div className="space-y-8">
              <div className="flex flex-col items-center">
                <div className="w-[120px] h-[120px] rounded-full border-2 border-dashed border-[#FF6B00] bg-[#FFF3E8] flex flex-col items-center justify-center cursor-pointer mb-3 relative overflow-hidden" onClick={() => updateForm("foto", "sim")}>
                  {formData.foto ? (
                    <ImageWithFallback src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?q=80&w=250&auto=format&fit=crop" alt="Perfil" className="w-full h-full object-cover" />
                  ) : (
                    <>
                ...
                <p className="text-[13px] text-[#6B6B6B] text-center w-[200px]">Toque para tirar foto ou escolher da galeria (opcional)</p>
              </div>
              ...
              <div className="flex items-start gap-3 mt-12">
                ...
                <p className="text-[13px] text-[#6B6B6B] pt-0.5 leading-tight">
                  Aceito os <span className="text-[#FF6B00] font-medium underline">Termos de Uso</span> e <span className="text-[#FF6B00] font-medium underline">Política de Privacidade</span>
                </p>
              </div>
