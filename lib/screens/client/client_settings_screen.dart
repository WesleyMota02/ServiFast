...
class ClientSettingsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Text('Perfil', style: TextStyle(color: AppTheme.textPrimary, fontSize: 18, fontWeight: FontWeight.bold)),
        leading: IconButton(
  ...
  Widget _buildProfileContent(BuildContext context, WidgetRef ref, User user) {
    // Para simplificar, vou ler o nome diretamente ou usar um mock temporário
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          Text(user.displayName ?? 'Cliente ServiFast', style: Theme.of(context).textTheme.titleLarge),
